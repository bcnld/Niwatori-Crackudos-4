window.startNewGame = async function () {
  ...
  function flyOut(otherIndex, selectedIdx){
    ...
    new Audio("Sounds/fly_out.mp3").play().catch(()=>{});
  }
  ...
  function flyIn(index){
    ...
    new Audio("Sounds/fly_in.mp3").play().catch(()=>{});
  }
  ...
  function createPopup(){
    ...
    Object.assign(popup.style,{
      ...
      zIndex:1800, overflow:"hidden", pointerEvents:"auto", opacity:1
    });
    ...
    if(selected.type==="img"){
      ...
      mediaEl.src=selected.src; mediaEl.autoplay=true; mediaEl.loop=true; mediaEl.muted=false;
      Object.assign(mediaEl.style,{width:"100%",height:"100%",objectFit:"contain"});
      mediaEl.play().catch(()=>{});
    }
  ...
  fakeBtn.addEventListener("click",()=>{ alert("…戻れません！"); });
