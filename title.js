document.addEventListener("DOMContentLoaded", () => {
  ...
  Object.assign(scrollWrapper.style,{
    position:"fixed", top:"0", left:"0", width:`${containerWidth}px`, height:`${containerHeight}px`,
  ...
  function createMenu(){
    ...
    menuItems.forEach((text,i)=>{
      ...
      item.addEventListener("click",()=>{
        ...
        } else { selectedIndex=i; isInputMode=true; updateMenuHighlight(); }
      });
      item.addEventListener("mouseenter",()=>{
        if(selectedIndex!==i){ selectedIndex=i; isInputMode=false; updateMenuHighlight(); }
      });
